...
export default function Home() {
  return (
    <div className="w-full bg-white">
      {/* Header */}
      <header className="w-full h-16 bg-white border-b border-gray-100 flex items-center justify-between px-6">
        {/* Logo */}
        ...
        <nav className="flex gap-12 items-center">
          <a href="#shop" className="font-bold text-sm text-black hover:text-gray-600">Shop</a>
          <a href="#services" className="font-bold text-sm text-black hover:text-gray-600">Services</a>
          <a href="#trainers" className="font-bold text-sm text-black hover:text-gray-600">Trainers</a>
          <a href="#gyms" className="font-bold text-sm text-black hover:text-gray-600">Gyms</a>
        </nav>
        ...
        <div className="flex gap-5 items-center">
          ...
          <button className="w-9 h-9 rounded hover:bg-gray-100 flex items-center justify-center">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m6.364 1.636l-.707-.707M21 12h-1m1.364 6.364l-.707-.707M12 21v1m6.364-1.636l-.707.707M3 12h1M3.636 5.636l.707.707M12 3a9 9 0 110 18 9 9 0 010-18z" />
            </svg>
          </button>
          <button className="w-9 h-9 rounded hover:bg-gray-100 flex items-center justify-center">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Trust Signals */}
      <section className="w-full py-6 px-6 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto flex justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gray-100 rounded flex items-center justify-center">✓</div>
            <span className="font-bold text-sm text-black">Lifetime Warranty</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gray-100 rounded flex items-center justify-center">📦</div>
            <span className="font-bold text-sm text-black">Free Shipping</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gray-100 rounded flex items-center justify-center">✔</div>
            <span className="font-bold text-sm text-black">Certified Equipment</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gray-100 rounded flex items-center justify-center">🆘</div>
            <span className="font-bold text-sm text-black">Expert Support</span>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-xs font-black uppercase tracking-wider text-gray-900 mb-2">New arrivals</p>
            <h2 className="text-3xl font-black text-black mb-4">Featured Equipment</h2>
            <p className="text-base text-gray-500 max-w-lg">Hand-picked, verified and ready to ship from our Knowledge base</p>
          </div>
          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition">
              <div className="h-64 bg-gray-200 relative">
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  <span className="bg-black text-white text-xs font-black px-2 py-1 rounded">✓ VERIFIED</span>
                  <span className="bg-orange-500 text-white text-xs font-black px-2 py-1 rounded">-25%</span>
                </div>
                <button className="absolute top-2 right-2 w-8 h-8 bg-white/80 rounded-full flex items-center justify-center hover:bg-white">♡</button>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-500 mb-2">Dumbbells · IronCore</p>
                <h3 className="font-bold text-black mb-3">Pro Hex Dumbbell Set 5-50lbs</h3>
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-xl font-black text-black">$599</span>
                  <span className="text-sm text-gray-500 line-through">$799</span>
                </div>
                <button className="w-full bg-black text-white font-bold py-2 rounded hover:bg-gray-900">🛒 Add to Cart</button>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition">
              ...
              <div className="p-4">
                <p className="text-xs text-gray-500 mb-2">Racks · TitanForge</p>
                <h3 className="font-bold text-black mb-3">Olympic Power Rack PRO-X</h3>
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-yellow-500">★★★★★</span>
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-xl font-black text-black">$1299</span>
                  <span className="text-sm text-gray-500 line-through">$1599</span>
                </div>
                <button className="w-full bg-black text-white font-bold py-2 rounded hover:bg-gray-900">🛒 Add to Cart</button>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition">
              ...
              <div className="p-4">
                <p className="text-xs text-gray-500 mb-2">Supplements · PureFuel</p>
                <h3 className="font-bold text-black mb-3">Premium Whey Isolate 5lb</h3>
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-yellow-500">★★★★★</span>
                  <span className="font-bold text-sm text-black">4.7</span>
                  <span className="text-xs text-gray-500">(1204)</span>
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-xl font-black text-black">$79</span>
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition">
              <div className="h-64 bg-gray-200 relative">
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  <span className="bg-black text-white text-xs font-black px-2 py-1 rounded">✓ VERIFIED</span>
                  <span className="bg-black text-white text-xs font-black px-2 py-1 rounded">REFURB</span>
                  <span className="bg-orange-500 text-white text-xs font-black px-2 py-1 rounded">-17%</span>
                </div>
                <button className="absolute top-2 right-2 w-8 h-8 bg-white/80 rounded-full flex items-center justify-center hover:bg-white">♡</button>
              </div>
              <div className="p-4">
                <p className="text-xs text-gray-500 mb-2">Cardio · RunForge</p>
                <h3 className="font-bold text-black mb-3">Commercial Treadmill T-9000</h3>
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-yellow-500">★★★★★</span>
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-xl font-black text-black">$2499</span>
      ...
      <section className="w-full py-16 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-xs font-black uppercase tracking-wider text-gray-900 mb-2">Shop the floor</p>
            <h2 className="text-3xl font-black text-black mb-4">Shop by Category</h2>
          </div>
      ...
      <section className="w-full py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-xs font-black uppercase tracking-wider text-gray-900 mb-2">We build it</p>
            <h2 className="text-3xl font-black text-black mb-4">Professional Services</h2>
            <p className="text-base text-gray-500 max-w-2xl">From design to install to maintenance — turnkey for your fitness goals</p>
          </div>
            ...
            {[
              ...
              <div key={idx} className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition">
                ...
                <div className="p-6">
                  ...
                  <p className="font-black text-lg text-gray-900 mb-4">{service.price}</p>
                  <p className="text-sm text-gray-500 mb-4">Premium service with complete support</p>
                  ...
                  <button className="text-black font-bold hover:text-gray-600">Learn More →</button>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="w-full py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <p className="text-xs font-black uppercase tracking-wider text-gray-900 mb-2">Real talk</p>
            <h2 className="text-3xl font-black text-black">What lifters say</h2>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition">
                ...
                <p className="text-sm text-black mb-4 leading-relaxed">"{testimonial.text}"</p>
                <div className="flex items-center justify-between">
                  <span className="font-bold text-black">{testimonial.name}</span>
                  <span className="text-xs text-black">✓ Verified</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="w-full py-16 px-6 bg-cover bg-center relative" style={{backgroundImage: 'linear-gradient(90deg, rgba(3, 2, 19, 0.95) 0%, rgba(3, 2, 19, 0.7) 100%), url(/trainers-bg.jpg)'}}>
        <div className="max-w-7xl mx-auto">
          <div className="text-white max-w-lg">
            ...
            <button className="px-6 py-3 bg-white text-black font-black rounded hover:bg-gray-100">Find Your Trainer →</button>
          </div>
        </div>
      </section>
      ...
      <footer className="w-full bg-white border-t border-gray-100 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-5 gap-8 mb-8 pb-8 border-b border-gray-200">
            <div>
              <div className="w-36 h-9 bg-gray-200 rounded mb-4"></div>
              <p className="text-sm text-gray-500 mb-4">Premium gym equipment, supplements, services and trainers.</p>
              <div className="flex gap-3">
                <button className="w-8 h-8 bg-gray-100 rounded hover:bg-gray-200">f</button>
                <button className="w-8 h-8 bg-gray-100 rounded hover:bg-gray-200">𝕏</button>
              ...
              <div key={idx}>
                ...
                <ul className="space-y-2">
                  {section.links.map((link, i) => (
                    <li key={i}><a href="#" className="text-sm text-gray-500 hover:text-black">{link}</a></li>
                  ))}
                </ul>
              </div>
            ))}
